...
//
//                     sh '''
//                         if docker ps -a --format '{{.Names}}' | grep -q "^${SELENIUM_CONTAINER}$"; then
//                             echo "Cleaning up old ${SELENIUM_CONTAINER} container..."
//                             docker stop ${SELENIUM_CONTAINER} || true
//                             docker rm ${SELENIUM_CONTAINER} || true
//                         fi
//                     '''
//
//                     sh '''
//                         echo "Starting selenium-chrome container..."
//                         docker run -d -p 4444:4444 --name ${SELENIUM_CONTAINER} selenium/standalone-chrome:latest
//                     '''
//
//                     sh '''
//                         echo "Waiting for Selenium to become ready..."
...
//                             -w /tests \
//                             --network=host \
//                             maven:3.9.6-eclipse-temurin-17 mvn clean install
//                     '''
//                 }
//             }
//         }
